...
public class LinkedTree {
    ...
    private static boolean anyGreaterInTree(Node root, int v) {
        if (root == null) {    
            ...
            return (root.key > v || anyGreaterInRight);
        }
    }    
    ...
    private class InorderIterator implements LinkedTreeIterator {
        ...
        public int next() {
            ...
            else if ((nextNode.parent.right == nextNode) && (nextNode.right == null)) {
                Node trav = nextNode;
                while (true) {
                    trav = trav.parent;
                    if (trav.parent == null) {
            ...
            else if ((nextNode.parent.left == nextNode) && (nextNode.right == null)) {
    ...
    public static void main(String[] args) {
        ...
        int[] keys = {2, 12, 6, 8, 9, 15, 14, 13, 19, 25, 49, 51};
        tree.insertKeys(keys);
        tree.levelOrderPrint();
        System.out.println(tree.anyGreater(50));
       ...
       LinkedTreeIterator iterator = tree2.inorderIterator();
